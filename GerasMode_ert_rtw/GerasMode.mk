###########################################################################
## Makefile generated for Simulink model 'GerasMode'. 
## 
## Makefile     : GerasMode.mk
## Generated on : Mon Nov 07 20:20:20 2016
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/GerasMode.elf
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = GerasMode_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/GerasMode.elf
...
DEFINES_ = -DMODEL=GerasMode -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DARM_PROJECT -D_USE_TARGET_UDP_ -D_RUNONTARGETHARDWARE_BUILD_ -DRT -DSTACK_SIZE=64
...
DEFINES_STANDARD = -DMODEL=GerasMode -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = GerasMode.c GerasMode_data.c linuxinitialize.c
...
OBJS = GerasMode.c.o GerasMode_data.c.o linuxinitialize.c.o
